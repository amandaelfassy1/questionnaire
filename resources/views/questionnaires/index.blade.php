...
@section('content')
    <div class="container mx-auto px-6 py-8">
        <h2 class="text-3xl font-bold text-gray-800 mb-6 flex items-center">
            📋 Les événements auxquels j'ai participés
        </h2>
                                ...
                                @foreach($event->questionnaires as $questionnaire)
                                    <li>
                                        <a href="{{ route('questionnaires.fill', $questionnaire->id) }}" 
                                           class="flex items-center bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200">
